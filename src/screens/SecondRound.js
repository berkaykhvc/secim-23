...
function SecondRound() {
  return (
    <div className='secondRound'>
      <hr className='mb-10 my-auto border-0 w-full h-3 bg-red-950'/>
      <strong className='text-5xl font-konkhmer text-red-500 flex flex-col'> İKİNCİ TUR SONUÇLARI </strong>
      <div className='flex flex-row mt-10 justify-between'>
      <div className='relative erdogan flex flex-row items-end border-8 border-yellow-400 h-44 rounded bg-yellow-700 lg:w-[25%]'>
        ...
        <strong className='absolute whitespace-nowrap font-konkhmer text-xl right-0 bottom-[20%] mb-2 mr-1'>%52.11</strong>
      ...
      <div className='relative kilicdaroglu flex flex-row items-end border-8 mt-2 border-red-600 h-44 rounded bg-red-900 lg:w-[24.7%] lg:ml-2 lg:mt-0'>
        ...
        <strong className='absolute whitespace-nowrap font-konkhmer text-xl right-0 bottom-[20%] mb-2 mr-1'>%47.89</strong>
        <div className="loadingchp relative w-full rounded mb-1 ml-[8px] mr-1">
          ...
          <div style={{width:"47.89%"}} className="absolute h-10 rounded-sm bg-gradient-to-br from-red-500 via-red-800 shim-chp"/>
        </div>
      </div>
    </div>
    </div>
